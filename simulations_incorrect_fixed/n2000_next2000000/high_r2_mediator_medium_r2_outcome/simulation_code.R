...
r2.outcome <- 0.5
n.external.ratio <- 1000
is.same.external <- FALSE
total.effect.external <- 2
...
setwd("/filepath/simulations_incorrect_fixed/n2000_next2000000/high_r2_mediator_medium_r2_outcome/intermediate_results/")
