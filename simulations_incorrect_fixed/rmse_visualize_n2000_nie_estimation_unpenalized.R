...
rel.sq.plot <- ggplot(data = plot.df, aes(x = Method, y = rel.sq.err)) + geom_point(size = 3) +
                      ...
                      ggtitle("IE Estimation, Incongenial Simulation Settings (n = 2000)") +
...
pdf("rmse_results_n2000_nie_unpenalized_incorrect_fixed.pdf", onefile = FALSE, width = 8, height = 10)
print(rel.sq.plot)
dev.off()
